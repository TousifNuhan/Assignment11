        ...
        <div className='  pb-10 pt-28 '>
            <div className='flex items-start w-4/5 mx-auto '>
                <div className='w-1/3 mr-8 '>
                    ...
                    <h1 className='text-5xl font-bold leading-16 my-3 text-base-content'>We <br /> Provide</h1>
                    <p className='text-gray-500 font-semibold leading-7 text-base w-full'>Our platform offers a seamless and interactive online group study experience with real-time collaboration, assignment management, and AI-powered study assistance. </p>
                </div>
                ...
                <>
                    ...
                    >
                        <SwiperSlide className='rounded-t-xl'>
                            <div className='bg-white min-h-80 shadow-[0_15px_20px_rgba(0,0,0,0.2)] rounded-t-xl'>
                        ...
                        <SwiperSlide className='rounded-t-xl'>
                            <div className='bg-white rounded-t-xl min-h-80 shadow-[0_15px_20px_rgba(0,0,0,0.2)]'>
