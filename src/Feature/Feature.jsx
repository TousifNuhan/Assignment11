            ...
            <div className='flex justify-center items-center gap-8 box-border my-10'>
                <div className='flex-1'>
                    ...
                    <div className='shadow-[0_15px_20px_rgba(0,0,0,0.2)] rounded-b-2xl bg-white px-3'>
                        <h4 className='font-bold text-lg text-[#111111] pt-7 mb-4 ml-5'>Collaborative Study Tools</h4>
                ...
                <div className='flex-1'>
                    ...
                    <div className='shadow-[0_15px_20px_rgba(0,0,0,0.2)] rounded-b-2xl bg-white px-3'>
                        <h4 className='font-bold text-lg text-[#111111] pt-7 mb-4 ml-5'>Smart Matching & Community</h4>
                ...
                <div className='flex-1'>
                  ...
                  <div className='shadow-[0_15px_20px_rgba(0,0,0,0.2)] rounded-b-2xl bg-white px-3'>
                        <h4 className='font-bold text-lg text-[#111111] pt-7 mb-4 ml-5'>Security & Privacy</h4>
