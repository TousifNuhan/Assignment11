            ...
            <div className=' w-11/12 mx-auto flex justify-center items-center lg:min-h-screen pt-28 pb-14'>
                ...
                <div className='flex-1  '>
                    <div className='text-white text-center'>
                        <h1 className='md:text-xl lg:text-2xl font-bold '>Join & Learn Together <br /> on PeerLearn!</h1>
                        <p className='md:text-sm lg:text-lg w-11/12 font-light mt-2 mb-7 text-center  mx-auto'>Access the ultimate online group study platform designed <br /> to help you collaborate.</p>
                    </div>
                    <div className='md:w-11/12 lg:w-4/5 mx-auto'>
                        <form onSubmit={handleLogin} className='text-center'>
                            ...
                            <div className='md:w-auto lg:w-4/5 mx-auto my-3 gap-1'>
                                <button type='submit' className='bg-white text-black rounded-md w-1/2 py-2 border border-white  font-semibold cursor-pointer md:ml-5 lg:ml-1'>Login</button>
                                <Link to="/register"><button className='hover:bg-white text-white hover:transition-all hover:delay-100 hover:text-black rounded-md w-2/5 py-2 px-3 border border-white font-semibold cursor-pointer ml-2'>Create Account</button></Link>
                            </div>
